  ...
  return (
    <div className="mx-auto bg-white text-black h-full relative print-no-padding flex flex-col justify-between" style={{ 
      ...
      <div className="flex flex-col">
        <h3 className="font-bold text-[14pt] uppercase bg-slate-900 px-3 text-[#fbfbff] flex items-center mb-6" style={{ width: '100%', height: '40px' }}>
          Dados Pessoais
        </h3>
        <div className="grid grid-cols-2 gap-x-8 gap-y-6 text-[12pt]">
      ...
      <div className="flex flex-col">
        ...
        <div className="grid grid-cols-2 gap-x-8 gap-y-6 text-[12pt]">
          ...
          <div className="grid grid-cols-2 gap-6 border-b border-slate-200 pb-4 col-span-2">
            <div>
